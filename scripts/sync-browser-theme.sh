...
#
# NOTE (2026-09-24): the brand profiles now carry their own accent hue via
# per-profile import files generated by tokens/codegen.py (see
# browser/README.md "Per-profile brand hues"). This clone resets them to
# sage — after running it, re-import each profile's
# browser/stylus/out/stylus-import.<profile>.json and
# browser/darkreader/darkreader.<profile>.json to restore the brand hue.
#
